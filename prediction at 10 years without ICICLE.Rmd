...
#refit model
model1.10<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.1,k=1,bknots = c(log(0.1067762),log(6.976044)),scale = "odds")


#linear predictor method 1
# Design matrix of predictors
des_matr1.10<-as.data.frame(model.matrix(~ age10+sex+mdsupdrs3.10+hybl,data=data10y.1v))
des_matr1.10$`(Intercept)` <- NULL
coef1.10<-c(model1.10$coefficients[4],model1.10$coefficients[5],model1.10$coefficients[6],model1.10$coefficients[7])
...
#refit model
model3.10<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.3,k=1,bknots = c(log(0.1067762),log(6.976044)),scale = "odds")

#linear predictor 
# Design matrix of predictors
des_matr3.10<-as.data.frame(model.matrix(~ age10+sex+mdsupdrs3.10+hybl,data=data10y.3v))
des_matr3.10$`(Intercept)` <- NULL
coef3.10<-c(model3.10$coefficients[4],model3.10$coefficients[5],model3.10$coefficients[6],model3.10$coefficients[7])
...
#refit model
model4.10<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.4,k=1,bknots = c(log(0.1067762),log(6.976044)),scale = "odds")

#linear predictor 
# Design matrix of predictors
des_matr4.10<-as.data.frame(model.matrix(~ age10+sex+mdsupdrs3.10+hybl,data=data10y.4v))
des_matr4.10$`(Intercept)` <- NULL
coef4.10<-c(model4.10$coefficients[4],model4.10$coefficients[5],model4.10$coefficients[6],model4.10$coefficients[7])
...
#refit model
model5.10<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.5,k=1,bknots = c(log(0.5557837),log(6.976044)),scale = "odds")

#linear predictor 
# Design matrix of predictors
des_matr5.10<-as.data.frame(model.matrix(~ age10+sex+mdsupdrs3.10+hybl,data=data10y.5v))
des_matr5.10$`(Intercept)` <- NULL
coef5.10<-c(model5.10$coefficients[4],model5.10$coefficients[5],model5.10$coefficients[6],model5.10$coefficients[7])
...
#refit model
model6.10<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.6,k=1,bknots = c(log(0.1067762),log(6.872005)),scale = "odds")

#linear predictor 
# Design matrix of predictors
des_matr6.10<-as.data.frame(model.matrix(~ age10+sex+mdsupdrs3.10+hybl,data=data10y.6v))
des_matr6.10$`(Intercept)` <- NULL
coef6.10<-c(model6.10$coefficients[4],model6.10$coefficients[5],model6.10$coefficients[6],model6.10$coefficients[7])
...
```{r  Moderate calibration 7 years}
...
vcal.1.10.RP <- flexsurvspline(Surv(year, cens) ~ risk.cll, data = data10y.1v, k=1,bknots = c(log(1.147159),log(6.773443)),scale = "odds")
...
vcal.3.10.RP <- flexsurvspline(Surv(year, cens) ~ risk.cll, data = data10y.3v, k=1,bknots = c(log(0.8925394),log(6.735113)),scale = "odds")
...
vcal.4.10.RP <- flexsurvspline(Surv(year, cens) ~ risk.cll, data = data10y.4v, k=1,bknots = c(log(1.990418),log(6.729637)),scale = "odds")
...
vcal.5.10.RP <- flexsurvspline(Surv(year, cens) ~ risk.cll, data = data10y.5v, k=1,bknots = c(log(0.1067762),log(6.872005)),scale = "odds")
...
vcal.6.10.RP <- flexsurvspline(Surv(year, cens) ~ risk.cll, data = data10y.6v, k=1,bknots = c(log(0.5557837),log(6.976044)),scale = "odds")
...
data10y.1v$pred.act<-predict(vcal.1.10.RP,type = "survival",times = 7,newdata = data10y.1v)[[2]] #actual survival 
...
calslope_summary.1.10 <- c(
  ...
  "2.5 %"  = val.1.10$coefficients[2] - 1.96 * 0.01046,
  "97.5 %" = val.1.10$coefficients[2] + 1.96 * 0.01046
)
calslope_summary.1.10

#---leave NYPUM out----

data10y.3v$pred.act<-predict(vcal.3.10.RP,type = "survival",times = 7,newdata = data10y.3v)[[2]] #actual survival 
...
calslope_summary.3.10 <- c(
  ...
  "2.5 %"  = val.3.10$coefficients[2] - 1.96 * 0.01399,
  "97.5 %" = val.3.10$coefficients[2] + 1.96 * 0.01399
)
...
data10y.4v$pred.act<-predict(vcal.4.10.RP,type = "survival",times = 7,newdata = data10y.4v)[[2]] #actual survival 
...
calslope_summary.4.10 <- c(
  ...
  "2.5 %"  = val.4.10$coefficients[2] - 1.96 * 0.005266,
  "97.5 %" = val.4.10$coefficients[2] + 1.96 * 0.005266
)
...
data10y.5v$pred.act<-predict(vcal.5.10.RP,type = "survival",times = 7,newdata = data10y.5v)[[2]] #actual survival 
...
calslope_summary.5.10 <- c(
  ...
  "2.5 %"  = val.5.10$coefficients[2] - 1.96 * 0.005661,
  "97.5 %" = val.5.10$coefficients[2] + 1.96 * 0.005661
)
calslope_summary.5.10

#---leave PINE out----

data10y.6v$pred.act<-predict(vcal.6.10.RP,type = "survival",times = 7,newdata = data10y.6v)[[2]] #actual survival 
...
calslope_summary.6.10 <- c(
  ...
  "2.5 %"  = val.6.10$coefficients[2] - 1.96 * 0.004428,
  "97.5 %" = val.6.10$coefficients[2] + 1.96 * 0.004428
)
...
model3.10.re<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.3,k=1,bknots = c(log(0.8925394),log(6.735113)),scale = "odds")  #change the knots position
...
data10y.3v$pred.re<-1/(1+exp(-15.5516366+0.2127671+1.5589806*data10y.3v$rcs1-0.6954149*data10y.3v$rcs2+data10y.3v$lp.3.10)) #change the knots position and s(lnt;r) but keep the linear predictor the same

(1-obj.3.10$surv)/mean(1-data10y.3v$pred.re) #Mean calibration improve
#Before is (1-obj.1$surv)/mean(1-data5y.1v$pred), 1.237097, now is 1.095688
...
model4.10.re<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.4,k=1,bknots = c(log(1.990418),log(6.729637)),scale = "odds")  #change the knots position
...
data10y.4v$pred.re<-1/(1+exp(-16.3312278-0.03665086+1.8903119*data10y.4v$rcs1-0.9449542*data10y.4v$rcs2+data10y.4v$lp.4.10)) #change the knots position and s(lnt;r) but keep the linear predictor the same
...
model5.10.re<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.5,k=1,bknots = c(log(0.1067762),log(6.872005)),scale = "odds")  #change the knots position
...
data10y.5v$pred.re<-1/(1+exp(-16.166035-0.4202508+1.372743*data10y.5v$rcs1-0.328912*data10y.5v$rcs2+data10y.5v$lp.5.10)) #change the knots position and s(lnt;r) but keep the linear predictor the same

(1-obj.5.10$surv)/mean(1-data10y.5v$pred.re) #Mean calibration improve
#Before is 0.66, now is 0.87
...
model6.10.re<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl,data=data10y.6,k=1,bknots = c(log(0.5557837),log(6.976044)),scale = "odds")  #change the knots position
...
data10y.6v$pred.re<-1/(1+exp(-19.0087726-0.05253184+1.5189759*data10y.6v$rcs1-0.6963724*data10y.6v$rcs2+data10y.6v$lp.6.10)) #change the knots position and s(lnt;r) but keep the linear predictor the same
...
```{r recalibration PINE}

summary(val.6.10)

data10y.6v$pred.re.1<-1/(1+exp(-19.0087726-0.05253184+5.95+1.5189759*data10y.6v$rcs1-0.6963724*data10y.6v$rcs2+0.569*data10y.6v$lp.6.10))

-14.31025+8.359801

(1-obj.6.10$surv)/mean(1-data10y.6v$pred.re.1) #Mean calibration decrease
#Before is 0.97,now 0.93
