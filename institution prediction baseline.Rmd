...
data5y.1v$pred.act<-predict(vcal.1.RP,type = "survival",times = 4,newdata = data5y.1v)[[2]] #actual survival 
...
calslope_summary.5 <- c(
  ...
  "2.5 %"  = val.5$coefficients[2] - 1.96 * 0.002963,
  "97.5 %" = val.5$coefficients[2] + 1.96 * 0.002963
)
...
calslope_summary.6 <- c(
  ...
  "2.5 %"  = val.6$coefficients[2] - 1.96 * 0.001036,
  "97.5 %" = val.6$coefficients[2] + 1.96 * 0.001036
)
...
```{r mean and weak calibration 4 year}
