...
data5y.6v$pred.re<-1/(1+exp(-21.016487+0.3555012+1.127613*log(4)-1.261545*data5y.6v$rcs2.re+data5y.6v$lp.6))

(1-obj.6$surv)/mean(1-data5y.6v$pred.re) #Mean calibration improve
#(1-obj.6$surv)/mean(1-data5y.6v$pred) improve 1.42 to 1.13
