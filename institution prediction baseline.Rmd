...
lp.1<-log(h.1[[2]]-h0.1[[2]]) #H(t)=H0(t)*exp(lp)
...
# Predicted risk 
data5y.1v$pred <- riskRegression::predictRisk(model1,
                                          newdata = data5y.1v,
                                          times = t_horizon)
# Expected
exp_t.1 <- mean(data5y.1v$pred)
...
#Need to find out the code for predict risk in RP model.
