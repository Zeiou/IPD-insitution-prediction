...
#refit the select model PO1 in to the first development datasets

model1<-flexsurvspline(Surv(year,cens)~age10+sex+mdsupdrs3.10+hybl+mmsebltotal+clus,data=data5y.1,k=1,bknots = c(log(0.1067762),log(9.943874)),scale = "odds")
...
data5y.1v$lp<-predict(model1,newdata = data5y.1v)
