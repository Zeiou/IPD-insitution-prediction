...
plot(KM10y.4v,col=c("red","darkblue","darkgreen"),ylim=c(0.3,1),lty = c(1,2,5),xlab = "Time to institutionalisation (years)",ylab = "Cumulative probability of non-institutionalisation",main="ParkWest")
