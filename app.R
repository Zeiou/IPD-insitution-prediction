...
ui <- fluidPage(
  ...
  div(style = "font-size:16px; margin-bottom: 30px;",
      HTML("<ul>
             ...
             <li style='color:red;'>The predictions generated by these models are intended for research purposes only. The models have not been externally validated outside similar Northern European cohorts and should not be used as the sole basis for clinical decision-making at the individual patient level.</li>
           </ul>")
  ),
